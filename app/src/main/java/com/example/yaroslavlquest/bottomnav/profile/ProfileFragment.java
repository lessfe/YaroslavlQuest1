...
public class ProfileFragment extends Fragment {
    ...
    ActivityResultLauncher<Intent> pcikImageActivityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
        @Override
    ...
    private void selectImage(){
        ...
        pcikImageActivityResultLauncher.launch(intent);
